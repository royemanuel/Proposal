% January 2015 (TOC contents linked in red in pdf file)
%This template was prepared by Dorothea F. Brosius of the 
%Institute for Electronics and Applied Physics, University of Maryland, College Park, MD
%The template was last updated in January 2015
...
%\include{YourInformation-Khubchandani} %Must be included to set your name, thesis year, advisor, etc. 
...
\bibliography{library} %replace "Galactic,Dottie" with the
